...
class CustomViewBase(viewsets.ModelViewSet):
    ...
    def list(self, request, *args, **kwargs):
        ...
        return JsonResponse(data=serializer.data, code=20000, msg="success", status=status.HTTP_200_OK)
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        return JsonResponse(data=[], code=20000, msg="delete resource success", status=status.HTTP_200_OK)
